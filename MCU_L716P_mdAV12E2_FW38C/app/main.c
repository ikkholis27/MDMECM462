...
uint32_t fota_write_start_addr=(uint32_t)0x08030000U, fota_write_end_addr=(uint32_t)0x0803F000U;
/* calculate the number of page to be programmed/erased */
uint32_t FotaPageNum;
/* calculate the number of page to be programmed/erased */
//uint32_t FotaWordNum;

static char MCU_SOFT_VERSION[]="MDA_V1.2E38C";
uint32_t *ptrd;
...
static char uart0_rxbuf[2300], uart0_rxbuf1[2300] = {0};
...
static char uart1_rxbuf[2300] = {0};
...
void uart0_handle(void)
{
    ...
    if(RESET != usart_interrupt_flag_get(USART0, USART_INT_FLAG_RBNE)){
			...
			rx_cnt++;
			if(rx_cnt>1){
				if(ch=='T' && uart0_rxbuf1[rx_cnt-2]=='A'){
					sim_flag=28;
				}
			}
			counter_wait_mtr=0;
