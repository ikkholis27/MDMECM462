...
static char MCU_SOFT_VERSION[]="MDA_V1.2E38A1T";
uint32_t *ptrd;
...
//				printf("\r\nMFOTA uart_index: %d %d\r\n", uart1_index, tempint2);
				...
				if(numinwhitelist==0 && tempint==100 && fotaerror>=100) printf("\r\nMFOTA FAILED WHEN DOWNLOADING\r\n");
					...
					sprintf(smsmsg,"MFOTA DONE SUCCESS. REBOOTING. PLEASE WAIT IN 3 MINUTES. FOTA Data %08jx at %08jx\r\n", (uintmax_t)fota_fwlast, (uintmax_t)fota_write_start_addr);
//				send_sms();
					send_sms_withsmsnum();
					delay(60);
				}
